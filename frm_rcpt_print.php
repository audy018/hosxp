  ...
  <table width="750" border="0" cellspacing='0' cellpadding='0'>
    ...
    <tr> 
      <td colspan="2"><font size="+2" face="AngsanaUPC, BrowalliaUPC, CordiaUPC">ชพ 
        0027.301/</font><font face="AngsanaUPC, BrowalliaUPC, CordiaUPC">&nbsp;</font></td>
...
?>
    ...
    <tr> 
      ...
      <td colspan="3"><font size="+2" face="AngsanaUPC, BrowalliaUPC, CordiaUPC"><strong>(&nbsp; 
        <?=num2wordsThai(floor($price))?>บาทถ้วน&nbsp;&nbsp;)&nbsp;&nbsp;รวมเป็นเงินค้างชำระทั้งสิ้น &nbsp; 
    ...
    <tr> 
      ...
      <td colspan="2"> <table width="392">
          <tr> 
            <td width="48">&nbsp;</td>
            <td width="332"><font size="+2" face="AngsanaUPC, BrowalliaUPC, CordiaUPC">&nbsp;&nbsp;(นายณัฐภัทร 
              &nbsp;&nbsp;สรรเพชร)</font></td>
          </tr>
        </table></td>
    </tr>
    ...
    <tr> 
      <td colspan="2"><font size="+2" face="AngsanaUPC, BrowalliaUPC, CordiaUPC">งานการเงินและบัญชี</font></td>
      <td><font face="AngsanaUPC, BrowalliaUPC, CordiaUPC">&nbsp;</font></td>
      <td><font face="AngsanaUPC, BrowalliaUPC, CordiaUPC">&nbsp;</font></td>
    </tr>
    <tr> 
      <td colspan="2"><font size="+2" face="AngsanaUPC, BrowalliaUPC, CordiaUPC">ฝ่ายบริหารงานทั่วไป</font></td>
      <td><font face="AngsanaUPC, BrowalliaUPC, CordiaUPC">&nbsp;</font></td>
      <td><font face="AngsanaUPC, BrowalliaUPC, CordiaUPC">&nbsp;</font></td>
    </tr>
    <tr> 
