...
<param name="Command" value="minimize">
        ...
        <tr> 
          <td width="637" height="187" valign="top" class="td-left"><div align="center"> 
              <p>&nbsp;</p>
              <table width="600" height="498" border="0" cellpadding="0" cellspacing="0" class="bd-external">
                <tr>
                  <td height="498" align="right"><table width="590" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="217" height="26" align="left"><strong> &nbsp;<font color="#FFFFFF"> ยินดีต้อนรับ คุณ</font><font color="#FFFFFF">&nbsp;</font><font color="red"> <?php echo $ip_Log;?></font></strong></td>
                      <td width="383" align="left">&nbsp;
                        </td>
                    </tr>
                    <tr>
                      <td align="left" background="img_mian/bgcolor.gif" class="headtable">&nbsp;<img src="img_mian/icon12.gif" width="22" height="16" align="absmiddle">สอบถามข้อมูล</td>
                      <td align="left">&nbsp;
                        </td>
                    </tr>
                    <tr>
                      <td align="left" bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;<img src="img_mian/collapsed.gif" width="5" height="5"> <a href="patient_search.php">ค้นหาผู้ป่วย</a></td>
                      <td class="headtable">&nbsp; <img src="img_mian/blank.gif" width="14" height="18" align="absmiddle"> News </td>
                    </tr>
                    <tr>
                      <td align="left" bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;<img src="img_mian/collapsed.gif" width="5" height="5"> <a href="patient_in_department_count.php">สรุปข้อมูลประจำวัน</a></td>
				  ...
				  ?></td>
                    ...
                    <tr>
                      <td align="left" bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;<img src="img_mian/collapsed.gif" width="5" height="5"> สอบถามผลตรวจทางห้องปฏิบัติการ</td>
                      </tr>
                    <tr>
                      <td align="left" bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;<img src="img_mian/collapsed.gif" width="5" height="5"> สรุปข้อมูลในฐานข้อมูล</td>
                      </tr>
                    <tr>
                      <td bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;<img src="img_mian/collapsed.gif" width="5" height="5"> <a href="pttype_service.php">ค้นหา OPD Card</a> </td>
                      </tr>
                    <tr>
                      <td bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;<img src="img_mian/collapsed.gif" width="5" height="5"><a href="icdsearch.php"> ค้นหารหัส icd10</a> </td>
                      </tr>
                    <tr>
                      <td bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;<img src="img_mian/collapsed.gif" width="5" height="5"><a href="hipdata.php"> HIP DATA</a> </td>
                      </tr>
                    <tr>
                    ...
                    <tr>
                      <td align="left" background="img_mian/bgcolor.gif" class="headtable">&nbsp;<img src="img_mian/icon12.gif" width="22" height="16" align="absmiddle">ระบบงาน Online</td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td align="left" bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;<img src="img_mian/collapsed.gif" width="5" height="5"> ระบบจองห้องพิเศษ                        </td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td align="left" bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;<img src="img_mian/collapsed.gif" width="5" height="5"> สรุปข้อมูลในฐานข้อมูล                        </td>
                    ...
                    <tr>
                      <td align="left" background="img_mian/bgcolor.gif" class="headtable">&nbsp;<img src="img_mian/icon12.gif" width="22" height="16" align="absmiddle">&nbsp;อื่นๆ</td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td align="left" bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;<img src="img_mian/collapsed.gif" width="5" height="5"> HOSxP Roadmap</td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td bgcolor="#FFFFFF">&nbsp; &nbsp;<img src="img_mian/collapsed.gif" width="5" height="5">&nbsp;<a href="account/account_main.php">ระบบเงินเดือน</a></td>
                      <td>&nbsp;</td>
                    </tr>
					<tr>
                      <td bgcolor="#FFFFFF">&nbsp;</td>
                    ...
                    <tr>
                      <td align="left" background="img_mian/bgcolor.gif" class="headtable">&nbsp;<img src="img_mian/icon12.gif" width="22" height="16" align="absmiddle">รายงาน</td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td align="left" bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;<img src="img_mian/collapsed.gif" width="5" height="5"> ผู้ป่วยความดันโลหิตสูง </td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;<img src="img_mian/collapsed.gif" width="5" height="5"> <a href="report_in_department_lr.php">ยอดผู้รับบริการคลอด</a></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;<img src="img_mian/collapsed.gif" width="5" height="5"> การวินิจฉัยโดย diag text </td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td bgcolor="#FFFFFF"> &nbsp; &nbsp;<img src="img_mian/collapsed.gif" width="5" height="5">&nbsp;<a href="report_in_department_den.php">ประกันสังคมทันตกรรม</a></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td bgcolor="#FFFFFF">&nbsp;</td>
                    ...
                    <tr>
                      <td align="left" background="img_mian/bgcolor.gif" class="headtable">&nbsp;<img src="img_mian/icon12.gif" width="22" height="16" align="absmiddle">System</td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
				...
				<?php
				  ...
				  ?>
                    ...
                    <tr>
                      <td align="left" bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;<img src="img_mian/collapsed.gif" width="5" height="5"> Current Activity</td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td align="left" bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;<img src="img_mian/collapsed.gif" width="5" height="5"> <a href="system_onlineuser.php">Current Online User</a></td>
                      <td>&nbsp;</td>
                    </tr>
                    <?php 
					if(check_right($_SESSION["right"],"ADMIN")){
				  ...
				  ?>
                    <tr>
                      <td bgcolor="#FFFFFF" align="left">&nbsp; &nbsp;<img src="img_mian/collapsed.gif" width="5" height="5"> <a href="user_command_view.php">Review Command Doctor</a></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td bgcolor="#FFFFFF">
				...
				if($rs['cc']<>0){
				  ...
				  ?>
                    ...
                    <tr>
                      <td background="img_mian/bgcolor.gif"><span class="headtable"><img src="img_mian/icon12.gif" width="22" height="16" align="absmiddle"><a href="about.php">About As </a></span></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td><span class="headtable"> &nbsp;</span></td>
                      <td>&nbsp;</td>
                    </tr>
                  </table></td>
                </tr>
