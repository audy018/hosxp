...
<?php if (Check_Online(get_ip()) and $Header=="N") {} else {include("header.inc");} ?>
	...
	<br><table width="625" border="0" cellspacing="0" cellpadding="0" class="bd-external">
                <tr align="center">
                  <td width="12635" colspan="4" bgcolor="#319ACE"><span class="headmenu">ทบทวน รายการอุบัติการ<br>
                  <h1>อยู่ระหว่างการแก้ไขโปรแกรม ยังไม่สามารถบันทึกการทบทวนได้</h1></span></td>
                  </tr>
			...
			//echo $rs['level_name'];
					...
					<?php
						if($rs['freq']){
						echo "<input type='text' name='freq' size='3'  style='color:white;background:red' id='Txt-Field' value='".$rs['freq']."' onkeyup=\"this.value=this.value.replace(/\D/g,'')\" onchange=\"this.value=this.value.replace(/\D/g,'')\"> ครั้ง&nbsp;<font color='red'>* เปลี่ยนแปลงค่าได้ เฉพาะตัวเลข</font>";
						}else{
						echo "<input type='text' name='freq' size='3'  style='color:white;background:red' id='Txt-Field' value='0' onkeyup=\"this.value=this.value.replace(/\D/g,'')\" onchange=\"this.value=this.value.replace(/\D/g,'')\"> ครั้ง&nbsp;<font color='red'>* เปลี่ยนแปลงค่าได้ เฉพาะตัวเลข</font>";
						}
					?></td>
                    </tr>
                    <tr>
    ...
    <option value="" selected>Choose a City:</option>
                ...
                <tr align="left">
				  ...
				  <form method="get" name="frisk_report"  action="<?php $PHP_SELF; ?>">
                    ...
                    <tr>
                      <td width="149" valign="top" bgcolor="#319ACE">&nbsp;ทบทวน : </td>
                    ...
                    <tr>
                      ...
                      <td bgcolor="#FFFFCE"> &nbsp;<?php if($rs['review_staff']){echo $rs['review_staff'];}else{echo "ยังไม่ทบทวน";} ?></td>
                    </tr>
                    <tr>
				...
				?>			  					  </td>
                    ...
                    <tr>
                      <td bgcolor="#319ACE">&nbsp;การทบทวน/แก้ไข</td>
			...
			<input type="button" VALUE="ย้อนกลับ" onClick="goHist(-1)"  id="Button"></td>
                    </tr>
                  </table>
				  </form></td>
                  </tr>
			...
			print"<br><font color='red'><b>*หลังจากที่ ทบทวนรายการอุบัติเรียบร้อยแล้ว กรุณากดปุ่ม Refresh</b></font>";
