...
<param name="Command" value="minimize">
        ...
        <tr> 
          <td width="637" height="187" valign="top"><div align="center"> 
              <p>&nbsp;</p>
              <table width="600" height="656" border="0" cellpadding="0" cellspacing="0" class="bd-external">
                ...
                <tr>
                  <td height="16" align="left"><table cellpadding="0" cellspacing="0">
                    <tbody>
                      <tr>
                        <td width="10"></td>
                        <td style="padding-top: 12px;" onMouseOver="this.style.cursor = 'hand'" title="เมนูหลัก" align="center" background="img_mian/bg_menu_on.gif" height="33" valign="top" width="117"> <b><font color="#000000">เมนูหลัก</font></b></td>
                        <td width="10"></td>
                        <td style="padding-top: 12px;" onMouseOver="this.style.cursor = 'hand'" title="สอบถามข้อมูล" align="center" background="img_mian/bg_menu_off.gif" height="33" valign="top" width="120"> สอบถามข้อมูล </td>
                        <td width="10"></td>
                        <td style="padding-top: 12px;" onMouseOver="this.style.cursor = 'hand'" title="รายงานต่างๆ" align="center" background="img_mian/bg_menu_off.gif" height="33" valign="top" width="120"> รายงานต่างๆ</td>
                        <td width="10"></td>
                        <td style="padding-top: 12px;" onMouseOver="this.style.cursor = 'hand'" title="System" align="center" background="img_mian/bg_menu_off.gif" height="33" valign="top" width="120">System</td>
                      </tr>
                      <tr>
                        <td width="10"></td>
                ...
                <tr>
                  <td height="498" align="right"><table width="590" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td align="right" valign="top" bgcolor="#FFBE00"><table width="192" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="192" align="left" bgcolor="#FFBE00">&nbsp;&nbsp;&nbsp;<img src="img_mian/collapsed.gif" width="5" height="5"> <a href="patient_search.php">ค้นหาผู้ป่วย</a></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td align="left" bgcolor="#FFBE00">&nbsp;&nbsp;&nbsp;<img src="img_mian/collapsed.gif" width="5" height="5"> <a href="medicate_err_form.php">รายงานความคลาดเคลื่อนทางยา</a></td>
                        </tr>
                        <tr>
				...
				if($rs['cc']<>0){
				  ...
				  ?>
                      ...
                      <td align="left" valign="top" class="headtable"><table width="397" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="8" height="28">&nbsp;</td>
                            <td width="378" background="img_mian/c3.jpeg ">&nbsp; <img src="img_mian/mail.gif" width="16" height="16" align="absmiddle"> <strong><font color="#FFBE00">ข่าว</font></strong> </td>
                            <td width="8" background="img_mian/c3.jpeg ">&nbsp;</td>
                          </tr>
                          <tr>
                            <td></td>
                            <td valign="top" bgcolor="#F7F7F7"><?php
					...
					echo "&nbsp;>>&nbsp;<font color=red><a href=set_pweb.php>กำหนดรหัสผ่าน</a></font>";
				  	...
				  	//call check login for  command_doctor
						...
						if($rs_chCom_doc['total']>0){
						 ...
						 print "&nbsp;&nbsp;<font size='2' color='green'><b>- ระบบสารสนเทศของโรงพยาบาล (ระบบอินทราเน็ต)</b></font>&nbsp;&nbsp;<a href='http://192.168.3.222/cpg/index.php' target='_blank'>คลิกที่นี่</a><br>&nbsp;&nbsp;<font  color='blue'>มีบทความมาใหม่น่าสนใจ เช่น <b><u>ทำเมลล์ 2 MB ของ Hotmail ให้เป็น 250 MB</u></b> ครับ</font><br>";
						 print "&nbsp;&nbsp;<font size='2' color='green'><b>- ข้อมูล 3DPDFA /การเชื่อมต่อบันไดขั้นที่ 1 สู่ขั้นที่ 2 และ HA(Series I)</b></font>&nbsp;&nbsp;ได้ที่เครื่องคุณ กอเดร์ ที่โฟลเดอร์ 3cpdfa ในระบบเครือข่าย<br>";
				  ?>
                              </td>
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td height="16" background="img_mian/c3.jpeg ">&nbsp;</td>
                            <td background="img_mian/c3.jpeg ">&nbsp;</td>
                          </tr>
                                            </table></td>
                    </tr>
                    <tr align="center">
			  ...
			  <?php print"<br><center>Development By <b>นพ.อรัญ รอกา, กูประจักษ์  ราเหม</b> CopyRight &copy; 04-2006 <br><b>IM Team Mayo Hospital.</b>All right reserved</center><br>"; ?><br>
          </td>
          <td width="163" valign="top" class="td-right" align="left"> 
            <?php
			echo "<table  width='163' border='0' cellspacing='0' cellpadding='0'><tr>";
            echo"<td height=\"58\" background=\"img_mian/login_bar.jpeg\" class=\"headtable\" align='center'>HOSxP Data Login</td></tr>";
            echo"<tr><td align=\"left\" bgcolor=\"#FFBE00\">";
