...
if((check_right($right,$aright)!==2) and (check_right($right,$aright2)!==1)){ //check access
			...
			print"Development By <b>Lamae Hospital</b> CopyRight &copy; 03-2010 <b>IM Team Lamae Hospital.</b>All right reserved</p>";
  ...
  <tr align="center" valign="top">
	...
	?>
        ...
        <table width="600" border="0" cellspacing="1" cellpadding="2">
		  ...
		  <tr>
            <td width="151" bgcolor="#319ACE">&nbsp;หน่วยงานที่พบอุบัติการณ์ : </td>
            <td colspan="3" bgcolor="#FFFFCC">&nbsp;<?php echo $rs['depart_name']; ?></td>
          </tr>

		  <tr>
            <td width="151" bgcolor="#319ACE">&nbsp;หน่วยงานที่่ต้องการสื่อสาร : </td>
            <td colspan="3" bgcolor="#FFFFCC">&nbsp;<?php echo $rs['department_risk']; ?></td>
          </tr>
...
// End -->
  ...
  <tr align="center" valign="top">
    <td colspan="2"><p align="center">Development By <b>Lamae Hospital</b> CopyRight &copy; 03-2010  <b>IM Team Lamae Hospital.</b>All right reserved
      </p></td>
  </tr>
</table><br>
<?php 
