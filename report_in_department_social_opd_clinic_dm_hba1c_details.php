...
<meta http-equiv="Content-Type" content="text/html; charset=tis-620">
 ...
 <HEAD>
  <TITLE> รายละเอียดประวัติการตรวจ HbA1c < 7% </TITLE>
...
AND o.vn = v.vn and c.clinic='001'  AND lo.lab_order_result<7  AND lo.lab_order_result!=''
 AND lo.lab_order_result!='-' AND lo.lab_order_result!='.'
 AND o.hn='$hn'
...
?>
						...
						<table width="900" border="1" cellpadding="1" cellspacing="1">
                          <tr>
                            ...
                            <td width="191" align="center"  background="img_mian/bgcolor2.gif">ค่า HbA1c</td>
