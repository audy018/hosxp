...
<HTML>
 ...
 <script language="javascript">
	...
	function confirm_delete(hn,begin_date)
	{
		...
		if(output==true){
			...
			window.location="report_in_department_social_opd_clinic_dm_new_register_clinic_cormobidity_list_delete.php?hn="+hn+"&begin_date=" + begin_date;
 ...
 <br/>
	...
	$sqlOpd_Socail="select cml.* ,cbd.name
					...
					left outer join clinic_cormobidity cbd on cbd.cormobidity = cml.cormobidity and cbd.clinic='001'
					 where cml.hn='$_GET[hn]' and cml.clinic=001";
