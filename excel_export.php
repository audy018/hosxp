...
$sql_ipd_Socail.="where  a.pcode='A7' and a.regdate between '$d1' and  '$d2' and a.pdx not between 'k000' 'k089' and pdx !='o800' and pdx!= 'z370' and pdx not like 'z35%' and pdx not like 'z36%' ";
...
$sql_ipd_Socail.="group by a.vn order by a.regdate,a.hn ";
				...
				if(mysql_num_rows($result_ipd_Socail)>0){ //row ipd
					print"ที่,บัตรประชาชน,HN,AN,วันที่ลงทะเบียน,วันที่จำหน่าย,ชื่อ-สกุล,อายุ(ปี),การวินิจฉัย(ICD10),หัตถการ(ICD9),ค่าบริการ, Adj RW\n";
						$i=0;
