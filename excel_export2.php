...
and v.pdx ='Z008' and p.nationality!=99 and v.pttype='42'";
				...
				if(mysql_num_rows($resultOpd_Socail)>0){ //row opd
					...
					print"ว/ด/ป ที่ลงทะเบียน,รหัสหน่วยงาน,เลขบัตรประจำตัว,คำนำหน้า,ชื่อ,สกุล,วันเกิด,เชื้อชาติ,ประเภท,เพศ,ที่อยู่,นายจ้าง,ชื่อนายจ้าง,เบอร์โทรศัพท์\n";
