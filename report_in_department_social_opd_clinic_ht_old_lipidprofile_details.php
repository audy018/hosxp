...
<?php
		...
		$sqlOpd_Socail.="AND o.vn = v.vn and c.clinic='002' and o.hn='$_GET[hn]' and c.new_case='N'";
...
?>
						...
						<table width="950" border="1" cellpadding="1" cellspacing="1">
                          <tr>
                            ...
                            <td width="191" align="center"  background="img_mian/bgcolor2.gif">รายการแล็ปที่สั่ง</td>
							 <td width="141" align="center"  background="img_mian/bgcolor2.gif">ผลแล็ป</td>
